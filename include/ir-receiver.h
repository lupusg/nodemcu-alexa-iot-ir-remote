 ...
 * @date July 16, 2022
 */
#ifndef NODEMCU_ALEXA_IOT_IR_REMOTE_INCLUDE_IR_RECEIVER_H_
#define NODEMCU_ALEXA_IOT_IR_REMOTE_INCLUDE_IR_RECEIVER_H_
...
const uint16_t kCaptureBufferSize = 600;
...
IRrecv ir_receiver(IR_RECEIVER_PIN, kCaptureBufferSize, kTimeout, false);
...
void HandleIrResults() {
  if (ir_receiver.decode(&results)) {
	...
	HttpPost(API_SIGNAL_URL, string_result);
...
#endif //NODEMCU_ALEXA_IOT_IR_REMOTE_INCLUDE_IR_RECEIVER_H_
